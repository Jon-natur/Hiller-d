...
var format_polygoner_2025vs3_3 = new ol.format.GeoJSON();
var features_polygoner_2025vs3_3 = format_polygoner_2025vs3_3.readFeatures(json_polygoner_2025vs3_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_polygoner_2025vs3_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_polygoner_2025vs3_3.addFeatures(features_polygoner_2025vs3_3);
var lyr_polygoner_2025vs3_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_polygoner_2025vs3_3, 
                style: style_polygoner_2025vs3_3,
                popuplayertitle: 'polygoner_2025 vs3',
                interactive: true,
                title: '<img src="styles/legend/polygoner_2025vs3_3.png" /> polygoner_2025 vs3'
            });

lyr_googlehybrid_0.setVisible(true);lyr_Kommunegrnse_Hillerd_1.setVisible(true);lyr_beskyttetnatur_Hillerdvs3beskyttede_naturtypervs3_2.setVisible(true);lyr_polygoner_2025vs3_3.setVisible(true);
var layersList = [lyr_googlehybrid_0,lyr_Kommunegrnse_Hillerd_1,lyr_beskyttetnatur_Hillerdvs3beskyttede_naturtypervs3_2,lyr_polygoner_2025vs3_3];
...
lyr_polygoner_2025vs3_3.set('fieldAliases', {'fid': 'fid', 'ID': 'ID', 'Naturtype': 'Naturtype', 'Hvorfor_be': 'Hvorfor_be', 'Bemærknin': 'Bemærknin', 'Areal': 'Areal', 'Besigtiget': 'Besigtiget', 'Luftfotona': 'Luftfotona', 'Skal ikke': 'Skal ikke', });
...
lyr_polygoner_2025vs3_3.set('fieldImages', {'fid': 'TextEdit', 'ID': 'TextEdit', 'Naturtype': 'TextEdit', 'Hvorfor_be': 'TextEdit', 'Bemærknin': 'TextEdit', 'Areal': 'TextEdit', 'Besigtiget': 'TextEdit', 'Luftfotona': 'TextEdit', 'Skal ikke': 'TextEdit', });
...
lyr_polygoner_2025vs3_3.set('fieldLabels', {'fid': 'no label', 'ID': 'no label', 'Naturtype': 'no label', 'Hvorfor_be': 'no label', 'Bemærknin': 'no label', 'Areal': 'no label', 'Besigtiget': 'no label', 'Luftfotona': 'no label', 'Skal ikke': 'no label', });
lyr_polygoner_2025vs3_3.on('precompose', function(evt) {
